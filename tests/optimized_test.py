...
TEST_CASES = [
    ...
    {"text": "哇哈哈，太高兴了！", "expected": "喜悦"},
    {"text": "激动人心的好消息！", "expected": "喜悦"},
    ...
    {"text": "痛苦不堪", "expected": "悲伤"},
    {"text": "欲哭无泪", "expected": "悲伤"},
    ...
    {"text": "忍无可忍！", "expected": "愤怒"},
    {"text": "给我滚！", "expected": "愤怒"},
    {"text": "滚开！", "expected": "愤怒"},
    {"text": "你太过分了！", "expected": "愤怒"},
    ...
    {"text": "提心吊胆", "expected": "恐惧"},
    {"text": "惶恐不安", "expected": "恐惧"},
    ...
    {"text": "这怎么可能！", "expected": "惊讶"},
    {"text": "匪夷所思", "expected": "惊讶"},
    ...
    {"text": "恶心死了", "expected": "厌恶"},
    {"text": "看着就烦", "expected": "厌恶"},
    {"text": "恶心的要命", "expected": "厌恶"},
    {"text": "低级趣味", "expected": "厌恶"},
    ...
    {"text": "就这样吧", "expected": "中性"},
    {"text": "不好不坏", "expected": "中性"},
    {"text": "马马虎虎", "expected": "中性"},
    {"text": "没有变化", "expected": "中性"},
    {"text": "按计划进行", "expected": "中性"},
    {"text": "和往常一样", "expected": "中性"},
    {"text": "平淡无奇", "expected": "中性"},
    {"text": "不过如此", "expected": "中性"},
    {"text": "中规中矩", "expected": "中性"},
    {"text": "有待观察", "expected": "中性"},
    ...
    {"text": "莫名其妙", "expected": "惊讶"},
    {"text": "不敢置信", "expected": "惊讶"},
    {"text": "不情不愿", "expected": "愤怒"},
    {"text": "无可奈何", "expected": "悲伤"},
    {"text": "左右为难", "expected": "恐惧"},
    {"text": "耿耿于怀", "expected": "愤怒"},
    {"text": "不屑一顾", "expected": "厌恶"},
    {"text": "不痛不痒", "expected": "中性"},
    {"text": "无关紧要", "expected": "中性"},
    {"text": "习以为常", "expected": "中性"},
    {"text": "事不关己", "expected": "中性"},
    {"text": "可有可无", "expected": "中性"},
    {"text": "不置可否", "expected": "中性"},
    {"text": "说来话长", "expected": "中性"},
    {"text": "顺便说一下", "expected": "中性"},
]
...
def generate_report(results, duration, filename):
    ...
    correct_count = len([r for r in results if r["是否正确"] == "✅ 正确"])
...
if __name__ == "__main__":
    ...
    filename = f"E:/毕设/tests/优化测试报告_{datetime.now().strftime('%Y%m%d_%H%M%S')}.xlsx"
